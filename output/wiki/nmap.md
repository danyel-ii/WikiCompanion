...
## Sources
- [Nmap Reference Guide (Man Page) — features, options, states, OS/service detection, NSE, output](https://nmap.org/book/man.html) (Nmap Project)
- [Port Scanning Techniques — conceptual mechanisms and scan types](https://nmap.org/book/man-port-scanning-techniques.html) (Nmap Project)
- [Nmap Version Detection and service probes (nmap-service-probes format)](https://nmap.org/book/vscan-fileformat.html) (Nmap Project)
- [Common Platform Enumeration (CPE) in Nmap output](https://nmap.org/book/output-formats-cpe.html) (Nmap Project)
- [Zenmap Reference Guide (GUI and results viewer)](https://nmap.org/zenmap/man.html) (Nmap Project)
- [Ndiff Reference Guide (differential reporting)](https://nmap.org/book/ndiff-man.html) (Nmap Project)
- [The Art of Port Scanning (background and design of scanning)](https://nmap.org/nmap_doc.html) (Nmap Project)
- [MITRE ATT&CK T1046: Network Service Discovery (context for detection and use)](https://attack.mitre.org/techniques/T1046) (MITRE)
- [ZMap Project (fast Internet-wide scanning, complementary to Nmap)](https://zmap.io/) (ZMap Project)
- [MASSCAN: Mass IP port scanner (complementary high-speed discovery)](https://github.com/robertdavidgraham/masscan) (GitHub)
- [https://nmap.org/docs.html](https://nmap.org/docs.html) (nmap.org)
- [https://nmap.org/nsedoc/lib/lpeg.html](https://nmap.org/nsedoc/lib/lpeg.html) (nmap.org)
